...
import {setResetEmail} from "../../store/authSlice.js"
...
export default function ForgotPassword() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      dispatch(setResetEmail(formData.login));
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-gray-950 px-4">
      <div className="w-full max-w-md bg-white dark:bg-gray-900 shadow-xl rounded-2xl p-8">
        ...
        <p className="text-center text-sm text-gray-600 dark:text-gray-400 mt-6">
          Enter the username or email to the account you want to reset password.
        </p>
